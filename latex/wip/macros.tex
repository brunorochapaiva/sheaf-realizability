...
\newcommand{\ILamU}[2]{{\mathop{\lambda{#1}.}{#2}}}
...
\newcommand{\ISheafMap}[1]{\ISheafSym{#1}}
...
%% Tripos
\newcommand{\TSym}{T}
\newcommand{\T}[1]{\TSym{#1}}

\newcommand{\TClSym}{Q}
\newcommand{\TCl}[1]{\TClSym{#1}}

\newcommand{\TInvSym}{\Phi^\ast}
\newcommand{\TInv}[1]{\TInvSym_{#1}}
\newcommand{\TDirSym}{\Phi_\ast}
\newcommand{\TDir}[1]{\TDirSym^{#1}}
